...
def server_loop(local_host,local_port,remote_host,remote_port,receive_first):
    ...
    while True:
        ...
        proxy_thread = threading.Thread(target=proxy_handler, args=(clien_socket,remote_port,receive_first))
...
#this is a pretyt hex dumping function directlu taken from 
#the comments here:
